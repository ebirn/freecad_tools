...
**Status**: ✅ COMPLETE
**Branch**: `copilot/optimize-github-workflow-ci` (merged to main)
**PRs**: #4 (CI workflow), #5 (setuptools fix)

**Description**: GitHub Actions workflow that mirrors pre-commit hook checks and runs the test suite on every push and PR.

**Completed**:
- ✅ `.github/workflows/ci.yml` created
- ✅ Triggers on push to main and all PRs
- ✅ Lint job: ruff check, ruff format, yamllint, pylint
- ✅ Test job: unit tests via pytest
- ✅ Fixed setuptools package discovery for CI
- ✅ Pinned actions to full SHA sums
